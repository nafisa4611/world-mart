        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {displayedProducts.map(p => (
            ...
            >
              ...
              {p.label && (
                <span
                  className={`absolute top-3 left-3 z-10 text-white text-xs font-bold px-2 py-1 rounded-full shadow ${badgeColors[p.label] || "bg-gray-500"}`}
                >
                  {p.label}
                </span>
              )}
              ...
              <div className="relative h-64 flex items-center justify-center bg-gray-50 overflow-hidden">
                ...
                <div className="absolute top-4 right-4 flex flex-col gap-3 opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500">
                  <button className="p-2 bg-white/80 backdrop-blur rounded-full shadow hover:bg-primary hover:text-white transition"><Heart className="w-4 h-4" /></button>
                  <button className="p-2 bg-white/80 backdrop-blur rounded-full shadow hover:bg-primary hover:text-white transition"><Eye className="w-4 h-4" /></button>
                  <button className="p-2 bg-white/80 backdrop-blur rounded-full shadow hover:bg-primary hover:text-white transition"><Repeat className="w-4 h-4" /></button>
                </div>
              </div>
